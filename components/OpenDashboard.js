...
export default function OpenDashboard({
  ...
  return (
    <main className="min-h-screen bg-gray-100">
      {/* Sticky Header */}
      <header
        className="sticky top-0 z-50 w-full rounded-b-[28px] bg-[#18a4e0] px-4 pb-5 pt-4 text-white shadow-md"
        style={{
          paddingTop:
        ...
        <div className="flex items-center">
          ...
          <div className="min-w-0 flex-1 overflow-hidden">
            <div className="overflow-hidden">
              <h1
                className="whitespace-nowrap text-[25px] font-semibold uppercase"
                title={marketTitle}
              >
                {marketTitle}
              </h1>
