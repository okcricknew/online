...
export default function OpenDashboard({
  ...
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      <header className="fixed inset-x-0 top-0 z-50 bg-[#18a4e0] rounded-b-[28px] px-4 pb-5 pt-4 text-white shadow-md">
        ...
        <div className="flex items-center min-w-0">
          ...
          <div className="min-w-0 flex-1 overflow-hidden">
            ...
            <div className="relative w-full overflow-hidden">
              ...
              <h1
                className="market-running-heading whitespace-nowrap text-[25px] font-semibold uppercase"
              >
                {market?.title ||
                  'MARKET'}{' '}
                DASHBOARD
      ...
      {/* =================================================
          ...
          Fixed header ke neeche content ko hide hone
          se bachane ke liye.
      ================================================= */}
      ...
      >
        ...
        {OPEN_GAME_TYPES.map(
          (gameType) => (
            <Link
              key={gameType}
              href={`/market/${market.id}/open/${encodeURIComponent(
                gameType
              )}`}
      ...
      <style jsx>{`
        .market-running-heading {
          display: inline-block;
          min-width: max-content;
        }

        .market-running-heading:hover {
          animation: marketHeadingRun 7s linear infinite;
        }

        @keyframes marketHeadingRun {
          0% {
