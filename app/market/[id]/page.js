...
export default async function MarketPage({ params }) {
  ...
  /*
   * Market closed hone par bhi page dikhayenge.
   * Lekin bidding controls abhi nahi honge.
   */
  const isClosed =
        ...
        <section className="overflow-hidden rounded-2xl bg-white shadow-sm">
          ...
          <div className="flex items-center justify-between bg-[#18a4e0] px-4 py-4 text-white">
            <div>
              ...
              <h2 className="mt-0.5 text-base font-extrabold uppercase">
                {game.title || game.name || 'MARKET'}
              </h2>
            </div>
          ...
          <div className="p-4">
            ...
            >
              ...
              <div
                className={[
                  'flex h-9 w-9 items-center justify-center rounded-full text-xl font-black',
                  isClosed
        ...
        <section className="mt-3 rounded-2xl bg-white p-4 shadow-sm">
          {isClosed ? (
            ...
            <div className="py-5 text-center">
              ...
              <p className="mt-1 text-xs text-gray-500">
                Bidding section will be added here.
              </p>
            </div>
          )}
        </section>
